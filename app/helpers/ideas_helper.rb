module IdeasHelper
  ...
  def users_marked_the_idea_good_tab_active_class
    return 'active' if "#{params[:controller].parameterize}_#{params[:action].parameterize}" == 'ideas_users_marked_the_idea_good'
  end

  def users_marked_the_idea_done_tab_active_class
    return 'active' if "#{params[:controller].parameterize}_#{params[:action].parameterize}" == 'ideas_users_marked_the_idea_done'
  end
